...
//                        $("#turnosDivContenedorEnlaceTicket").removeClass('hide');
                        $("#turnosFrameTicket").attr('src', url_relativa + 'turnos/vista/php/vista_ticket.php?turno=' + datos[0].turno + '&tramite=' + datos[0].tramite + '&fecha=' + datos[0].fecha + '&hora=' + datos[0].hora + '&espera=' + datos[0].espera);

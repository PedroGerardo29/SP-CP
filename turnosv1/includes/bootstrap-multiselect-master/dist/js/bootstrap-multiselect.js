    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return '<span style="float:left">' + this.nonSelectedText + '</span> ';
                }
                else if (options.length ===1) {
                    return '<span style="float:left">' + options.length +  ' Seleccionado' + '</span> ';
                }
                else if (options.length === $('option', $(select)).length) {
                    return '<span style="float:left">' +  this.allSelectedText + '</span> ';
                }
                else if (options.length > this.numberDisplayed) {
                    return '<span style="float:left">' + options.length + ' ' + this.nSelectedText + '</span> ';
                }
                else {
                    var selected = '';
                   ...
                   return '<span style="float:left">' + selected.substr(0, selected.length - 2) + '</span> ';
                }
            },
            /**
